...
`/ts_grid/templates/layout/html.html.twig`. Both files are placed in the same
`layout` directory, however the ts_grid file is the one being overridden and
...
`@include hocus { // Insert styles here }`
